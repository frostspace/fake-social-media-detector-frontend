...
export default function HomePage() {
  const title = "Fake Profile Detector"
      ...
      <div className="relative flex-1 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            >
              AI-powered tool to help you identify fake social media profiles with accuracy and precision.
            </motion.p>
            ...
            >
              <Link href="/upload">
                ...
                >
                  <span className="opacity-90 group-hover:opacity-100 transition-opacity">Verify Profile Now</span>
                  <span
